...
\begin{frame}{Forward vs Reverse KL (visual)}
  \centering
  \includegraphics[width=0.9\linewidth]{KL&Reverse_KL.html/20240112163924.png}
\end{frame}

% Another image if desired
\begin{frame}{Another KL intuition graphic}
  \centering
  \includegraphics[width=0.9\linewidth]{KL&Reverse_KL.html/20240112163931.png}
\end{frame}

% A generic RL image from the distillation page assets
\begin{frame}{RL context}
  \centering
  \includegraphics[width=0.7\linewidth]{On-Policy Distillation - Thinking Machines Lab_files/chess.png}
\end{frame}
