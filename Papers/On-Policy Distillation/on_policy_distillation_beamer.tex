...
% Fonts and encoding (XeLaTeX for Unicode paths)
\usepackage{fontspec}
...
\usepackage{graphicx}
% Make graphics lookup robust on Overleaf and local (handles spaces/Unicode)
\graphicspath{{On-Policy Distillation - Thinking Machines Lab_files/}{反向 KL 散度与正向 KL 散度 - 机器学习POD_files/}}
\usepackage{tikz}
...
\date{\today}
% Overleaf note: set Compiler to XeLaTeX (or LuaLaTeX) for Unicode paths and fontspec.
...
\begin{frame}{Forward vs Reverse KL (visual)}
  \centering
  % Image is in: 反向 KL 散度与正向 KL 散度 - 机器学习POD_files/20240112163924.png
...
\begin{frame}{Another KL intuition graphic}
  \centering
  % Image is in: 反向 KL 散度与正向 KL 散度 - 机器学习POD_files/20240112163931.png
  \includegraphics[width=0.9\linewidth]{20240112163931.png}
\end{frame}

% A generic RL image from the distillation page assets
\begin{frame}{RL context}
  \centering
  % Image is in: On-Policy Distillation - Thinking Machines Lab_files/chess.png
