...
On the training side, they also present superiority in the reinforcement learning (RL) of LLMs, particularly in improving training efficiency~\citep{sutton2018reinforcement} and credit assignment~\citep{leike2018scalable} compared with sparse outcome rewards.
