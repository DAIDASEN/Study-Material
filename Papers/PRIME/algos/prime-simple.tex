...
\textbf{Input} Language model $\pi_{\theta_{\text{init}}}$; outcome verifier $r_o$; dataset $\mathcal{D}$; sample number $K$; total iteration $N$.
...
\begin{algorithmic}[1]
\State Initialize policy model $\pi_\theta, \pi_{\theta_{\text{old}}} \leftarrow \pi_{\theta_{\text{init}}}$, implicit PRM and reference model $\pi_{\phi} ,\pi_{\text{ref}} \leftarrow \pi_{\theta_{\text{init}}}$
