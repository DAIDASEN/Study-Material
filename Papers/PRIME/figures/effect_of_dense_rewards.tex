\begin{figure*}[t]
    ...
    % }
    \textbf{The effect of dense reward.} We compare PRIME and RLOO with outcome verifier (OV). PRIME leads to \textbf{$2.5\times$} sample efficiency (wall clock as X axis can be found in Figure~\ref{fig:train_rewards_wall}) and \textbf{$6.9\%$} performance improvement. PRIME also substantially outperforms RLOO on downstream tasks.} % 整个图形的标题
