\begin{figure*}[t]
    ...
    \end{subfigure}
    \caption{\textbf{Comparison of different PRMs.} Online PRM initialized from SFT model achieved the best results. However, using PRMs trained on extra rollouts
    hurts the performance. } % 整个图形的标题
